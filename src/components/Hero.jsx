...
import HeroImage from '../assets/my_pic.jpg';
  ...
  return (
    <div id="home" className="bg-black text-white text-center py-16 px-4">
      ...
      <div className="mt-8 space-x-4">
        <button className="bg-gradient-to-r from-green-400 to-blue-500 px-6 py-2 rounded-full hover:scale-105 transition-transform duration-300">
          Contact Me
        </button>
