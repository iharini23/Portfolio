                ...
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    <div className='flex-1'>
                        ...
                        <div className='mb-4 mt-8'>
                            ...
                            <a href='mailto:iharini3123@gmail.com' className='hover:underline'>
                    ...
                    <div className='flex-1 w-full'>
                        <form className='space-y-4'>
                            ...
                            <div>
                                <label htmlFor='messgae' className='block mb-2'>Message</label>
                            ...
                            <button className="bg-gradient-to-r from-green-400 to-blue-500 px-8 py-2 rounded-full hover:scale-105 transition-transform duration-300 hidden md:inline">
                                Send
                            </button>
                        </form>
                    </div>
